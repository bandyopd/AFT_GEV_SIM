...
res <- list()
for(id in 1:50){
  fit <- readRDS(paste0("../../Result/simulation/sim", sim_id, "/res_id",id,"_GEVBP.RDS"))
  sc_fix <- apply(fit$draws("sc_fix"),3,cbind)
...
saveRDS(res, paste0("../Result/simulation/sim", sim_id, "/ind_selected_all_GEVBP.rds"))
