...
ind_all <- readRDS(paste0("../Result/simulation/sim", sim_id, "/ind_selected_all_NormalGP.rds"))
dat <- dat_all[[id]]
ind <- sort(ind_all[[id]])
...
file <- file.path("AFT_Normal_SIM_GP_GLT.stan")
...
fit$save_object(file = paste0("../Result/simulation/sim", sim_id, "/res_id",id,"_SelectedVariables_NormalGP.RDS"))
